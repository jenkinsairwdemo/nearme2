...
- (void)viewDidLoad{
    ...
    UIImage *unselectedImage = [UIImage imageNamed: @"OrdersNormal"];
    UIImage *selectedImage = [UIImage imageNamed: @"OrdersSelected"];
    [tabBarItem setImage: [unselectedImage imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate]];
    [tabBarItem setSelectedImage: [selectedImage imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate]];
    [tabBarItem setTitle:LOC(TBC_QUOTE)];
}
